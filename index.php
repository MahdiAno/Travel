      ...
      <div class="row">
        ...
        <div class="col-md-6 py-3 py-md-0">
          <form action="book.php" method="post">
            ...
            <input type="text" name="country" class="form-control" placeholder="Where To" required><br>
            <input type="text" name="ppl" class="form-control" placeholder="How Many" required><br>
            <input type="date" name="arrivals" class="form-control" placeholder="Arrivals" required><br>
            <input type="date" name="leaving" class="form-control" placeholder="Leaving" required><br>
            <textarea name="msg" class="form-control" rows="5" name="text" placeholder="Enter Your Name & Details"></textarea>
